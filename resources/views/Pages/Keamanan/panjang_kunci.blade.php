...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 border-right">
                        ...
                        <div class="form-group">
                            <button type="button" onclick="startUjiKunci()" class="btn btn-danger">Mulai Uji Kinerja</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-6 grid-margin stretch-card result-card">
        <div class="card">
            <div class="card-body text-center">
                Chipperteks Advanced Encryption Standard (AES):
                <div class="mt-3 mb-3" id="enkripsi-aes" style="font-weight: bolder"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 grid-margin stretch-card result-card">
        <div class="card">
            <div class="card-body text-center">
                Chipperteks Rivest Code 4 (RC4):
                <div class="mt-3 mb-3" id="enkripsi-rc4" style="font-weight: bolder"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 grid-margin stretch-card result-card">
        <div class="card">
            <div class="card-body text-center">
                Plainteks Advanced Encryption Standard (AES):
                <div class="mt-3 mb-3" id="dekripsi-aes" style="font-weight: bolder"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 grid-margin stretch-card result-card">
        <div class="card">
            <div class="card-body text-center">
                Plainteks Rivest Code 4 (RC4):
                <div class="mt-3 mb-3" id="dekripsi-rc4" style="font-weight: bolder"></div>
            </div>
        </div>
    </div>
...
<script src="{{ url('assets/js') }}/keamanan/panjang_kunci.js"></script>