                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <label class="col-form-label result-performance" id="panjangAES1"></label>
                            </div>
                            <div class="col-lg-5">
                                <label class="col-form-label">Kecepatan Enkripsi</label>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <label class="col-form-label result-performance" id="enkripsiAES1"></label>
                            </div>
                            <div class="col-lg-5">
                                <label class="col-form-label">Kecepatan Dekripsi</label>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <label class="col-form-label result-performance" id="dekripsiAES1"></label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label class="col-form-label text-red">Base64</label>
                            </div>
                            <div class="col-lg-5">
                                <label class="col-form-label">Panjang Enkripsi</label>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <label class="col-form-label result-performance" id="panjangBase64"></label>
                            </div>
                            <div class="col-lg-5">
                                <label class="col-form-label">Kecepatan Enkripsi</label>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <label class="col-form-label result-performance" id="enkripsiBase64"></label>
                            </div>
                            <div class="col-lg-5">
                                <label class="col-form-label">Kecepatan Dekripsi</label>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <label class="col-form-label result-performance" id="dekripsiBase64"></label>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="{{ url('assets/js') }}/kecepatan/teks.js"></script>